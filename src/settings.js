...
import { TG_VERSION, TG_ACCENTS, tgRead, tgReadRaw, tgWrite, tgRoot, tgApplyVariant, tgResolveVariant } from './boot.js?v=0.1.20';
...
function wire(panel) {
    ...
    enabled.addEventListener('change', async () => {
        ...
        if (next === 'off') {
            ...
            try {
                const { restorePreviousTheme } = await import('./theme.js?v=0.1.20');
